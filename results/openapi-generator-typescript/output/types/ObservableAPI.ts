...
export class ObservablePetApi {
     ...
     */
    public findPetsByStatusWithHttpInfo(status?: 'available' | 'pending' | 'sold', _options?: Configuration): Observable<HttpInfo<Array<Pet>>> {
     ...
     * @param [status] Status values that need to be considered for filter
     */
    public findPetsByStatus(status?: 'available' | 'pending' | 'sold', _options?: Configuration): Observable<Array<Pet>> {
     ...
     * @param [body]
     */
    public uploadFileWithHttpInfo(petId: number, additionalMetadata?: string, body?: HttpFile, _options?: Configuration): Observable<HttpInfo<ApiResponse>> {
        const requestContextPromise = this.requestFactory.uploadFile(petId, additionalMetadata, body, _options);
     ...
     * @param [body]
     */
    public uploadFile(petId: number, additionalMetadata?: string, body?: HttpFile, _options?: Configuration): Observable<ApiResponse> {
        return this.uploadFileWithHttpInfo(petId, additionalMetadata, body, _options).pipe(map((apiResponse: HttpInfo<ApiResponse>) => apiResponse.data));
    }
...
export class ObservableStoreApi {
     ...
     */
    public deleteOrderWithHttpInfo(orderId: number, _options?: Configuration): Observable<HttpInfo<void>> {
...
export class ObservableUserApi {
     ...
     * @param [user]
     */
    public createUsersWithListInputWithHttpInfo(user?: Array<User>, _options?: Configuration): Observable<HttpInfo<User>> {
     ...
     * @param [user]
     */
    public createUsersWithListInput(user?: Array<User>, _options?: Configuration): Observable<User> {
        return this.createUsersWithListInputWithHttpInfo(user, _options).pipe(map((apiResponse: HttpInfo<User>) => apiResponse.data));
    }
