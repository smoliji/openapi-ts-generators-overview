...
export class PromisePetApi {
     ...
     */
    public findPetsByStatusWithHttpInfo(status?: 'available' | 'pending' | 'sold', _options?: Configuration): Promise<HttpInfo<Array<Pet>>> {
     ...
     * @param [status] Status values that need to be considered for filter
     */
    public findPetsByStatus(status?: 'available' | 'pending' | 'sold', _options?: Configuration): Promise<Array<Pet>> {
     ...
     * @param [body]
     */
    public uploadFileWithHttpInfo(petId: number, additionalMetadata?: string, body?: HttpFile, _options?: Configuration): Promise<HttpInfo<ApiResponse>> {
        const result = this.api.uploadFileWithHttpInfo(petId, additionalMetadata, body, _options);
        return result.toPromise();
    }
     ...
     * @param [body]
     */
    public uploadFile(petId: number, additionalMetadata?: string, body?: HttpFile, _options?: Configuration): Promise<ApiResponse> {
        const result = this.api.uploadFile(petId, additionalMetadata, body, _options);
        return result.toPromise();
    }
...
export class PromiseStoreApi {
     ...
     */
    public deleteOrderWithHttpInfo(orderId: number, _options?: Configuration): Promise<HttpInfo<void>> {
...
export class PromiseUserApi {
     ...
     * @param [user]
     */
    public createUsersWithListInputWithHttpInfo(user?: Array<User>, _options?: Configuration): Promise<HttpInfo<User>> {
     ...
     * @param [user]
     */
    public createUsersWithListInput(user?: Array<User>, _options?: Configuration): Promise<User> {
